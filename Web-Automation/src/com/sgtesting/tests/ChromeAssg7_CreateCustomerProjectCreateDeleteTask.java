...
public class ChromeAssg7_CreateCustomerProjectCreateDeleteTask {
	...
	static void createTask()
	{
		try {
			...
			Thread.sleep(1000);
			//oBrowser.findElement(By.xpath("//*[@id='ext-gen173']")).click();
		//	oBrowser.findElement(By.xpath("//*[@id='ext-gen275']")).click();
		//	Thread.sleep(1000);
