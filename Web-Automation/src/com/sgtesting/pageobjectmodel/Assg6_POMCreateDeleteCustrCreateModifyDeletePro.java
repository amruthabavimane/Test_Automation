...
public class Assg6_POMCreateDeleteCustrCreateModifyDeletePro {
	...
	static void createProject()
	{
		try {
			...
			oPage.getNewProjectBtn().click();
			Thread.sleep(1000);
			oPage.getProjNameField().sendKeys("Proj1");
			Thread.sleep(1000);
			oPage.getProjDescField().sendKeys("Test desc");
			Thread.sleep(1000);
	...
	static void modifyProject()
	{
		try {
			...
			oPage.getEditProjectDesc().click();
			Thread.sleep(1000);
			oPage.getEditProjectDesc().sendKeys("Modify1");
			Thread.sleep(1000);
			oPage.getProjectTaskCloseBtn().click();
			Thread.sleep(1000);
	...
	static void deleteProject()
	{
		try {
			...
			Thread.sleep(1000);
			oPage.getProjectDeleteConfirmBtn().click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
