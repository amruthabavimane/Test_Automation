...
public class Assg4_POMCreateModifyDeleteCustomer {
	...
	static void modifyCustomer()
	{
		try {
			...
			Thread.sleep(1000);
			oPage.getEditCustomerDesc().click();
			Thread.sleep(1000);
			oPage.getEditCustomerDesc().sendKeys("Tester");
			Thread.sleep(1000);
			oPage.getCustomerTaskCloseBtn().click();
			Thread.sleep(1000);
